vcpkg install curl[openssl]:x64-windows-static json-c:x64-windows-static libxml2:x64-windows-static pcre2:x64-windows-static pthreads:x64-windows-static zlib:x64-windows-static pdcurses:x64-windows-static  bzip2:x64-windows-static check:x64-windows-static
